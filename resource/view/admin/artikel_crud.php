...
<div class="admin-header">  
    <h2><i class="bi bi-journal-text m-2"></i> Kelola Artikel</h2>
</div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="hapus_artikel.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin ingin menghapus artikel ini?')" class="btn btn-sm btn-danger">
